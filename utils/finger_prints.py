...
class ccus_fps(object):
    ...
    def __init__(self, fingerprint_version: int = 1, names: list = None, substructures: list = None,
        ...
        self.version_explanations = {
            1: "This is a filtered set which seems to perform well for modelling but does not include rarer groups like"
            "sulphur containing hetrocycles.",
            2: "This is a filtered set which seems to perform well for modelling this finger print includes rarer groups like"
            "sulphur."
            }
